...
const ProgressCharts = () => {
  ...
  const labels = getLast7Days().map((d) => d.label);
    ...
    datasets: [
      {
        ...
        data: weeklyData,
        borderColor: "rgba(236, 72, 153, 1)", // pink neon
  ...
  const options = {
    responsive: true,
    maintainAspectRatio: false, // auto-adjusts height
    plugins: {
      legend: {
        labels: {
          color: "#e5e7eb", // gray-200
          font: {
            size: 14, // laptop default
          },
        },
      },
    },
  ...
  return (
    <section className="my-8 mx-6">
      ...
      {/* Chart wrapper - bigger on laptop, compact on mobile */}
      <div
